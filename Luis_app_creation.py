...
authoring_key = '5524cbfbe1ab4ad9b906d1f21d8c1ef4'

authoring_endpoint = 'https://bot-voyage-authoring.cognitiveservices.azure.com/'
# </AuthorizationVariables>
...
def create_app():
	...
	app_name    = "Cauquy_app {}".format(datetime.datetime.now())
